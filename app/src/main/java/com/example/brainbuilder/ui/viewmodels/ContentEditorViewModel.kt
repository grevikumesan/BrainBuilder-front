...
import com.example.brainbuilder.ui.uistate.ContentEditorUiState
...
class ContentEditorViewModel(
    ...
    val uiState: StateFlow<ContentEditorUiState> = _uiState
    ...
    fun submit() {
        ...
        viewModelScope.launch {
            ...
            try {
                val response = contentEditorRepository.createCourse(buildRequest(_uiState.value))
    ...
    fun startNewCourse() {
        _uiState.value = ContentEditorUiState()
    }
    ...
    private fun buildRequest(state: ContentEditorUiState): CreateCourseRequest {
